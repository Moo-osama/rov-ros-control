...
PidObject::PidObject() : error_(3, 0), filtered_error_(3, 0), error_deriv_(3, 0), filtered_error_deriv_(3, 0)
{
  ...
  node_priv.param<std::string>("topic_from_controller", topic_from_controller_, "depth_control_effort");
  node_priv.param<std::string>("topic_from_plant", topic_from_plant_, "depth_state");
  node_priv.param<std::string>("setpoint_topic", setpoint_topic_, "depth_setpoint");
