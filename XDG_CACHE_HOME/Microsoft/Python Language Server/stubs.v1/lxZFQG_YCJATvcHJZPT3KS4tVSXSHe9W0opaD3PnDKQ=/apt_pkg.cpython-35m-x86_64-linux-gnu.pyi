...
__file__ = '/usr/lib/python3/dist-packages/apt_pkg.cpython-35m-x86_64-linux-gnu.so'
__name__ = 'apt_pkg'
__package__ = ''
...
def parse_depends(s: str, strip_multi_arch: bool=True):
...
def parse_src_depends(s: str, strip_multi_arch: bool=True):
